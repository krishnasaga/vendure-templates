...
export type GetSelectedCollectionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSelectedCollectionsQuery = { __typename?: 'Query', collections: { __typename?: 'CollectionList', totalItems: number, items: Array<{ __typename?: 'Collection', id: string, name: string, slug: string, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, parent?: { __typename?: 'Collection', id: string, name: string } | null }> } };
...
export type GetCollectionProductsQuery = { __typename?: 'Query', search: { __typename?: 'SearchResponse', totalItems: number, items: Array<{ __typename?: 'SearchResult', productName: string, slug: string, currencyCode: CurrencyCode, productAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, priceWithTax: { __typename?: 'PriceRange', min: any, max: any } | { __typename?: 'SinglePrice', value: any } }> } };


export const GetSelectedCollectionsDocument = gql`
...
/**
 * __useGetSelectedCollectionsQuery__
 *
 * To run a query within a React component, call `useGetSelectedCollectionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSelectedCollectionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetSelectedCollectionsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetSelectedCollectionsQuery(baseOptions?: Apollo.QueryHookOptions<GetSelectedCollectionsQuery, GetSelectedCollectionsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSelectedCollectionsQuery, GetSelectedCollectionsQueryVariables>(GetSelectedCollectionsDocument, options);
      }
export function useGetSelectedCollectionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSelectedCollectionsQuery, GetSelectedCollectionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSelectedCollectionsQuery, GetSelectedCollectionsQueryVariables>(GetSelectedCollectionsDocument, options);
        }
export function useGetSelectedCollectionsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetSelectedCollectionsQuery, GetSelectedCollectionsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetSelectedCollectionsQuery, GetSelectedCollectionsQueryVariables>(GetSelectedCollectionsDocument, options);
        }
export type GetSelectedCollectionsQueryHookResult = ReturnType<typeof useGetSelectedCollectionsQuery>;
export type GetSelectedCollectionsLazyQueryHookResult = ReturnType<typeof useGetSelectedCollectionsLazyQuery>;
export type GetSelectedCollectionsSuspenseQueryHookResult = ReturnType<typeof useGetSelectedCollectionsSuspenseQuery>;
export type GetSelectedCollectionsQueryResult = Apollo.QueryResult<GetSelectedCollectionsQuery, GetSelectedCollectionsQueryVariables>;
...
/**
 * __useGetCollectionProductsQuery__
 *
 * To run a query within a React component, call `useGetCollectionProductsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCollectionProductsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCollectionProductsQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *      skip: // value for 'skip'
 *      take: // value for 'take'
 ...
 * });
 */
export function useGetCollectionProductsQuery(baseOptions: Apollo.QueryHookOptions<GetCollectionProductsQuery, GetCollectionProductsQueryVariables> & ({ variables: GetCollectionProductsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCollectionProductsQuery, GetCollectionProductsQueryVariables>(GetCollectionProductsDocument, options);
      }
export function useGetCollectionProductsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCollectionProductsQuery, GetCollectionProductsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCollectionProductsQuery, GetCollectionProductsQueryVariables>(GetCollectionProductsDocument, options);
        }
export function useGetCollectionProductsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetCollectionProductsQuery, GetCollectionProductsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetCollectionProductsQuery, GetCollectionProductsQueryVariables>(GetCollectionProductsDocument, options);
        }
export type GetCollectionProductsQueryHookResult = ReturnType<typeof useGetCollectionProductsQuery>;
export type GetCollectionProductsLazyQueryHookResult = ReturnType<typeof useGetCollectionProductsLazyQuery>;
export type GetCollectionProductsSuspenseQueryHookResult = ReturnType<typeof useGetCollectionProductsSuspenseQuery>;
export type GetCollectionProductsQueryResult = Apollo.QueryResult<GetCollectionProductsQuery, GetCollectionProductsQueryVariables>;
