            ...
            <div class="relative h-[600px]">
                <div class="absolute inset-0 overflow-hidden">
                    <Image
                        ...
                        width="800"
                        height="600"
                        src={"https://images.unsplash.com/photo-1526406915894-7bcd65f60845?q=80&w=1924&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
                        alt="Background header photo of bicycle taken by Mikkel Bech"
                    />
                    <div class="absolute inset-0 bg-green" />
                </div>
                ...
                <div class="relative max-w-3xl mx-auto py-32 px-6 flex flex-col items-center text-center sm:py-64 lg:px-0">
                    <div class="relative bg-zinc-800 bg-opacity-0 rounded-lg p-0">
                        <h1 class="text-3xl text-transparent bg-clip-text font-extrabold tracking-normal lg:text-6xl bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600">
                            {$localize`This is an E-commerce Webisite by Vendure and qwik `}
                        </h1>
                    </div>
                    ...
                    <p class="mt-4 text-2xl text-white">
                        ...
                        <a
                            ...
                            target="_blank"
                            class="text-white-300 hover:text-blue-500"
                        >
                            Vendure
                        </a>{' '}
                        &{' '}
