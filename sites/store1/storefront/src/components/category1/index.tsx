...
export default component$(() => {
	return (
		<div class="bg-orange-500 p-8">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 container mx-auto px-4">
				...
				{[
					...
					<div key={category.name} class="bg-white rounded-sm shadow-md overflow-hidden">
